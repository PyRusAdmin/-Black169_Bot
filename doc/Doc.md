...
Телеграм-бот для кальянной The Black 169. Позволяет гостям регистрироваться, отслеживать бонусы, участвовать в акциях и получать подарки. Интегрирован с системой лояльности QuickResto через API.
...
- Интеграция с QuickResto API (поиск, создание клиентов, начисление бонусов)
- Главное меню с inline-кнопками
- Просмотр бонусов, акций, мероприятий
- Получение подарков (промокоды)
- 🎰 Колесо подарков (ежедневный розыгрыш)
